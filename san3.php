...
[['text'=>'- صانع بوتات ' ,'callback_data'=>"mak6"],['text'=>'- بوت سايت ' ,'callback_data'=>"mak2"]],
[['text'=>'- بوت الازرار ' ,'callback_data'=>"mak3"],['text'=>'- بوت المتجر ' ,'callback_data'=>"mak4"]],
[['text'=>'- بوت البصمات ' ,'callback_data'=>"mak5"],['text'=>'- بوت تواصل  ' ,'callback_data'=>"mak1"]],
[['text'=>'- بوت التعليقات ' ,'callback_data'=>"mak7"],['text'=>'-  ادارة منشورات القناة  ' ,'callback_data'=>"mak8"]],
[['text'=>'- بوت زخرفة ' ,'callback_data'=>"mak9"],['text'=>'- بوت ترجمة ' ,'callback_data'=>"mak10"]],
[['text'=>'- القرآن الكريم  ' ,'callback_data'=>"mak11"],['text'=>'-  بوت العاب انلاين ' ,'callback_data'=>"mak12"]],
[['text'=>'- بوت تحويل الصيغ ' ,'callback_data'=>"mak13"],['text'=>'- إستخراج روابط القنوات ' ,'callback_data'=>"mak14"]],
[['text'=>'- بوت همسة ' ,'callback_data'=>"mak15"],['text'=>'- بوت كشف الكذب ' ,'callback_data'=>"mak16"]],
...
[['text'=>'- بوت تحويل الصيغ ' ,'callback_data'=>"mak13"],['text'=>'- إستخراج روابط القنوات ' ,'callback_data'=>"mak14"]],
[['text'=>'- بوت همسة ' ,'callback_data'=>"mak15"],['text'=>'- بوت كشف الكذب ' ,'callback_data'=>"mak16"]],
[['text'=>'- حذف الحساب  ' ,'callback_data'=>"mak17"],['text'=>'- بوت الاعلانات ' ,'callback_data'=>"mak18"]],
[['text'=>'- بوت الاذكار ' ,'callback_data'=>"mak19"],['text'=>'- بوت الاكواد الجاهزة ' ,'callback_data'=>"mak20"]],
[['text'=>'- بوت حساب العمر ' ,'callback_data'=>"mak21"],['text'=>'-  تحميل انستقرام ' ,'callback_data'=>"mak22"]],
[['text'=>'- البلورة السحرية  ' ,'callback_data'=>"mak23"],['text'=>'- زخرفة تمبلر ' ,'callback_data'=>"mak24"]],
[['text'=>'- مشاركة بدون توجية ' ,'callback_data'=>"mak25"],['text'=>'- حجر ورقة مقص ' ,'callback_data'=>"mak26"]],
[['text'=>'- حماية القنوات ' ,'callback_data'=>"mak27"],['text'=>'- تمويل القنوات ' ,'callback_data'=>"mak28"]],
[['text'=>'- نسبة الحب ' ,'callback_data'=>"mak29"],['text'=>'- بوت دعم القنوات ' ,'callback_data'=>"mak30"]],
[['text'=>'• العودة • ' ,'callback_data'=>"freebot"]],
   ] 
   ])
]);
...
'inline_keyboard'=>[
[['text'=>'• قائمة البوتات • ' ,'callback_data'=>"null"]],
[['text'=>'- مصنع بوتات ' ,'callback_data'=>"ngl6"],['text'=>'- بوت سايت ' ,'callback_data'=>"ngl2"]],
[['text'=>'- بوت الازرار ' ,'callback_data'=>"ngl3"],['text'=>'- بوت المتجر ' ,'callback_data'=>"ngl4"]],
[['text'=>'- بوت البصمات ' ,'callback_data'=>"ngl5"],['text'=>'-  بوت تواصل ' ,'callback_data'=>"ngl1"]],
[['text'=>'- بوت التعليقات ' ,'callback_data'=>"ngl7"],['text'=>'-  ادارة منشورات القناة  ' ,'callback_data'=>"ngl8"]],
[['text'=>'- بوت زخرفة ' ,'callback_data'=>"ngl9"],['text'=>'- بوت ترجمة ' ,'callback_data'=>"ngl10"]],
[['text'=>'- القرآن الكريم  ' ,'callback_data'=>"ngl11"],['text'=>'-  بوت العاب انلاين ' ,'callback_data'=>"ngl12"]],
[['text'=>'- بوت تحويل الصيغ ' ,'callback_data'=>"ngl13"],['text'=>'- إستخراج روابط القنوات ' ,'callback_data'=>"ngl14"]],
[['text'=>'- بوت همسة ' ,'callback_data'=>"ngl15"],['text'=>'- بوت كشف الكذب ' ,'callback_data'=>"ngl16"]],
[['text'=>'- حذف الحساب  ' ,'callback_data'=>"ngl17"],['text'=>'- بوت الاعلانات ' ,'callback_data'=>"ngl18"]],
[['text'=>'- بوت الاذكار ' ,'callback_data'=>"ngl19"],['text'=>'- بوت الاكواد الجاهزة ' ,'callback_data'=>"ngl20"]],
[['text'=>'- بوت حساب العمر ' ,'callback_data'=>"ngl 21"],['text'=>'-  تحميل انستقرام ' ,'callback_data'=>"ngl22"]],
[['text'=>'- البلورة السحرية  ' ,'callback_data'=>"ngl23"],['text'=>'- زخرفة تمبلر ' ,'callback_data'=>"ngl24"]],
[['text'=>'- مشاركة بدون توجية ' ,'callback_data'=>"ngl25"],['text'=>'- حجر ورقة مقص ' ,'callback_data'=>"ngl26"]],
[['text'=>'- حماية القنوات ' ,'callback_data'=>"ngl27"],['text'=>'- تمويل القنوات ' ,'callback_data'=>"ngl28"]],
[['text'=>'- نسبة الحب ' ,'callback_data'=>"ngl29"],['text'=>'- بوت دعم القنوات ' ,'callback_data'=>"ngl30"]],
[['text'=>'• العودة • ' ,'callback_data'=>"botsmember"]],
   ] 
   ])
]);
